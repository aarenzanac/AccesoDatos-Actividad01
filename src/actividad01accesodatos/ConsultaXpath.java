...
public class ConsultaXpath {
    ...
    public int abrir_file_DOM(){
        ...
        try {
            ...
            XMLDoc = factory.newDocumentBuilder().parse(new InputSource(new FileInputStream("/home/alex/NetBeansProjects/Actividad01AccesoDatos/src/actividad01accesodatos/incidencias.xml")));
            //Al llegar aquí ya se ha creado la estructura DOM para su consultada
            return 0;
        }
        catch (Exception ex) {
